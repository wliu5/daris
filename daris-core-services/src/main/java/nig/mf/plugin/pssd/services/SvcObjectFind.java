...
import daris.plugin.services.SvcProjectUserList;
...
public class SvcObjectFind extends PluginService {
     ...
     */
    public static void addPssdObjects(ServiceExecutor executor, XmlWriter w, XmlDoc.Element r, boolean isleaf,
            boolean showMembers, boolean forEdit, boolean showRSubjectIdentity, boolean showSubjectPrivate)
            throws Throwable {

        addPssdObjects(executor, w, r.elements("asset"), isleaf, showMembers, forEdit, showRSubjectIdentity,
                showSubjectPrivate, true);
    }
...
//						addPssdProject(executor, proute, w, ae, dProject.getCiteableID(), selfRoles, methods, pmmap);
					    // @formatter:on
                        addPssdProject(executor, proute, w, ae, dProject.getCiteableID(), selfRoles, methods,
                                showMembers);
...
//        Boolean readOnly = true;
    ...
    public static void addPssdStudy(XmlWriter w, XmlDoc.Element ae, boolean forEdit) throws Throwable {
        ...
        Collection<XmlDoc.Element> otherIDs = se.elements("other-id");
        if (otherIDs != null) {
...
//    }
    ...
    public static void addPssdProject(ServiceExecutor executor, String proute, XmlWriter w, XmlDoc.Element ae,
            String projectId, ModelUserRoleSet selfRoles, MethodSet methods, boolean showMembers) throws Throwable {
        //
        /*
         * Indicate if the user is allowed to create Subject objects for this
         * project
        ...
        if (showMembers) {
            XmlDocMaker dm = new XmlDocMaker("args");
            dm.add("cid", new String[] { "proute", proute }, projectId);
