...
public class Project {
    ...
    // @formatter:off
	/*
	 * types of ethical consent for use and reuse of human data
	 * 
	 * There are used to specify
	 * 
	 * 
	 * 1) the overall project data-use characteristics,
	 * 
	 * 2) Subject-specific data-use characteristics (e.g. to over-ride 1)
	 * 
	 * 3) How a user wants to use project data
	 */
    //@formatter:on
    /**
     * specific: original project concept use
     */
    public static final String CONSENT_SPECIFIC_ROLE_NAME = "specific";
    /**
     * extended: use for original and related work
     */
    public static final String CONSENT_EXTENDED_ROLE_NAME = "extended";
    /**
     * unspecified: use for any research
     */
    public static final String CONSENT_UNSPECIFIED_ROLE_NAME = "unspecified";
    ...
    /**
     * Project specific dictionary namespace prefix
     */
    public static final String PROJECT_SPECIFIC_DICTIONARY_NAMESPACE_PREFIX = "daris-project-";
    ...
    public static String projectSpecificDictionaryNamespaceOf(String projectCid) {
        return PROJECT_SPECIFIC_DICTIONARY_NAMESPACE_PREFIX + projectCid;
    }
    ...
    public static void createProjectSpecificDictionaryNamespace(ServiceExecutor executor, String projectCid)
        ...
        dm.add("description", "Dictionary namespace for project " + projectCid);
        executor.execute("dictionary.namespace.create", dm.root());

        grantProjectSpecificDictionaryNamespacePermissions(executor, projectCid);
    }

    private static void grantProjectSpecificDictionaryNamespacePermissions(ServiceExecutor executor, String projectCid)
            throws Throwable {
