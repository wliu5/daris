...
public class Study {
	...
	public static String update(ServiceExecutor executor, String id,
			...
			Collection<XmlDoc.Element> otherIDs, String exMethod, String step, boolean allowIncompleteMeta,
		...
		if (exMethod != null || step != null || type != null
			...
			if (otherIDs!=null) {
				...
				Collection<XmlDoc.Element>oldOtherIDs = oldEl.elements("other-id");
