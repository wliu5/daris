...
public class Study {
    ...
    public static final String OTHER_ID_DICTIONARY = "daris:pssd.study.other-id.types";
    ...
    public static String create(ServiceExecutor executor, DistributedAsset dExMethod, long studyNumber, String type,
            String name, String description, Collection<XmlDoc.Element> otherIDs, Boolean processed, String step,
            boolean allowIncompleteMeta, XmlDoc.Element meta, DistributedAsset dProject, boolean fillIn)
            throws Throwable {
        ...
        if (otherIDs != null) {
            for (XmlDoc.Element otherID : otherIDs) {
                dm.add(otherID);
            }
        }
    ...
    public static String update(ServiceExecutor executor, String id, String type, String name, String description,
            Boolean processed, Collection<XmlDoc.Element> otherIDs, String exMethod, String step,
            boolean allowIncompleteMeta, XmlDoc.Element meta) throws Throwable {
        ...
        if (exMethod != null || step != null || type != null || processed != null || otherIDs != null) {
            ...
            if (otherIDs != null) {
                ...
                List<XmlDoc.Element> oldOtherIDs = oldEl.elements("other-id");
                if (oldOtherIDs != null) {
                    for (XmlDoc.Element oldOtherID : oldOtherIDs) {
                        dm.add(oldOtherID);
                    }
                }
            }
        ...
        // Generate system event
        SystemEventChannel
                .generate(new PSSDObjectEvent(Action.MODIFY, id, SvcCollectionMemberCount.countMembers(executor, id)));
        return id;
