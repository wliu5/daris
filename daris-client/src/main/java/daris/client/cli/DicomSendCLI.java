...
public class DicomSendCLI {
    ...
    private static void forceDelete(File file) throws IOException {
        daris.util.FileUtils.delete(file.toPath());
    }
    ...
    private static void printUsage() {
        ...
        System.out.println(
                "    --element     <[a]tag=value>   The element value to override. Can occur more than once to override multiple elements. The usage of [a] symbol is described in 'Element Actions'. Example of [op]tag=value: \"+(0010,0020)=ABC123\"");
        System.out.println(
                "    --tmp         <tmp-dir>     The temporary directory to save the modified dicom files. The files will be deleted after uploading. Defaults to user's home directory.");
        System.out.println("");
        System.out.println("Element Actions:");
        System.out.println(
                "    +       Replace the element value or add the element if it does not exist. If action symbol is omitted, this is the default action.");
        ...
        System.out.println(
                "    --element \"+(0010,0020)=123\"    set patient id to 123. If the element does not exist, add the element and set the value to 123");
        System.out.println("    --element \"-(0019,0020)\"        remove element (0019,0020)");
        System.out.println(
                "    --element \"&(0019,0020)\"        set the value of existing element (0019,0020). Ignore if the element does not exist.");
        System.out.println(
                "    --element \"#(0020,0011)=1\"      set the value of (0020,0011) to 1 if the element pre-exists and its value is empty.");
        System.out.println("    --element \"(0010,0020)=123\"     same as \"+(0010,0020)=123\"");
        System.out.println(
                "    --element \"&(0010,0010)=''\"     set the patient name to empty if the element pre-exists.");
        System.out.println("");
