...
import daris.client.ui.project.ProjectUserGUI;
import daris.client.ui.project.ProjectRoleUserGUI;
...
public class DObjectGUIRegistry {
	...
	public static SystemObjectGUIRegistry get() {
		...
		if (!_registered) {
			...
			registry.add(Project.User.class, ProjectUserGUI.INSTANCE);
			registry.add(Project.RoleUser.class, ProjectRoleUserGUI.INSTANCE);
