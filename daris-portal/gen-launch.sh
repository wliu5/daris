...
# <stringAttribute key="org.eclipse.jdt.launching.PROGRAM_ARGUMENTS" value="-war target/daris-portal-1.3.0 -noserver -nostartServer -nosuperDevMode -codeServerPort 9997 -startupUrl DaRIS.html daris.DaRIS"/>